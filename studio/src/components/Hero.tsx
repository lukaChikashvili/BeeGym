...
const Hero = () => {
  return (
    <div className="w-full  min-h-screen flex items-center justify-center">
        <div className="w-1/2 text-center flex items-center flex-col gap-8"  >
            <h1 className="text-yellow-500 text-8xl ">Unleash Your <span className="text-white ">Strength, </span><span className="text-white">Elevate</span> Your Wellness</h1>
